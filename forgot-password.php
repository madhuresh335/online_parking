                    ...
                    <div class="login-space mt-3">
                        <div class="login">
                            ...
                            <div class="group">
                                ...
                                <input id="new_password" type="Password" class="input  form-control"
                                    placeholder="Enter your password" onclick="validatepassword('new_password')">
                                <div id="new_password_error" class="error"></div>
                            </div>
                            <div class="group">
                                <label class="label">OTP</label>
                                <input id="otp" type="text" onblur="validateotp('otp')" class="input form-control"
                                    maxlength="10" minlength="10" placeholder="Enter your otp">
