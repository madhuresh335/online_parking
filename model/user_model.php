...
function register_user($post)
{
    ...
    if ($user_data[0] > 0) {
        ...
        $insert_sql = "INSERT INTO `op_user` (`user_name`, `phone_number`, `password`) VALUES ('$user_name', '$phone_number', '$pass_signUp')";
...
function verify_otp($post)
{
    ...
    if ($otp_time_interval > 3) {
        ...
        if ($otp_value == $otp) {
            ...
            print_r(json_encode(array("result" => "invalid")));
            exit;
        }
    }
}else{
